# Welcome to the DATA VISUALIZER Contributing Guide <!-- omit in toc -->
...
## Getting Started
DATA VISUALIZER is built with React, Reaflow for visualization, Mantine UI for components, Zustand for state management. If you are not familiar with these technologies, we recommend you to read their documentation to get started. You can find the links to the respective documentations below:
...
Once you are familiar with these technologies, you can clone the DATA VISUALIZER repository by running the following command:
...
### 1. Performance
Performance is an important criteria for DATA VISUALIZER. Any new contributions should not affect the re-rendering of the application. Therefore, when making changes to the code, please keep performance in mind.
...
## Conclusion
We appreciate any contributions to DATA VISUALIZER, big or small. If you have any questions or need any help, please do not hesitate to reach out to us. Thank you for contributing!

### Your PR is merged!

Congratulations :tada::tada: The DATA VISUALIZER team thanks you :sparkles:.

Once your PR is merged, your contributions will become part of the next DATA VISUALIZER release, and will be visible in the [DATA VISUALIZER app](https://jsoncrack.com).
