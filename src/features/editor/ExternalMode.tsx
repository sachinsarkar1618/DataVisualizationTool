...
const ExternalMode = () => {
  ...
  return (
    <StyledAlert>
      ...
      <Modal title="External Host of DATA VISUALIZER" opened={isOpen} onClose={closeModal} centered>
        <Group>
          ...
          <Text>
            ...
            <Anchor href="https://jsoncrack.com">DATA VISUALIZER</Anchor>. Your continued support is
