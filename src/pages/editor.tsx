...
const EditorPage = () => {
  ...
  return (
    <>
      <NextSeo
        {...SEO}
        title="Editor | DATA VISUALIZER"
        description="DATA VISUALIZER Editor is a tool for visualizing into graphs, analyzing, editing, formatting, querying, transforming and validating JSON, CSV, YAML, XML, and more."
